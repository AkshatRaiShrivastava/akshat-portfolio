  ...
  return (
    <nav className=" flex items-center justify-between py-6 mb-10 lg:px-10">
      ...
      <div className="m-8 flex items-center justify-center gap-4 text-2xl">
        ...
        <a href="https://x.com/AkshShriv2005">
          <FaSquareXTwitter />
        </a>
        ...
        <AlertDialog open={isOpen} onOpenChange={setIsOpen}>
          <AlertDialogTrigger asChild>
            <MdOutlineAdminPanelSettings className="cursor-pointer" />
          </AlertDialogTrigger>
          <AlertDialogContent className="bg-neutral-200 opacity-1">
            <AlertDialogHeader>
              ...
              <AlertDialogDescription>
                <input
                  ...
                  type="password"
                  className="w-full border-b placeholder-black border-black bg-transparent p-2 outline-none"
            ...
            <AlertDialogFooter>
              ...
              <button
                className="w-auto bg-black text-neutral-200 px-2 rounded-lg"
